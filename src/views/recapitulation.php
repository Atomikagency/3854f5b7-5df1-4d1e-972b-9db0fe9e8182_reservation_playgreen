    ...
    <div class="reservation-recap-card">
        <div class="reservation-recap-card-game-container">
            ...
            <div>
                ...
                <?php if($reservation_data['is_prix_fixe'] === 'off'){ ?>
                ...
                <div class="reservation-recap-price" style="justify-self: flex-end;">
                    <p class="reservation-recap-price-total">Total: <span id="price-with-discount"><?php echo (number_format(floatval($reservation_data['total']), 2, '.', '')); ?></span> €</p>
                    <?php if ($reservation_data['totalBeforeDiscount'] !== $reservation_data['total']) { ?>
                        <p class="reservation-recap-price-without-discount"><span id="price-without-discount"><?php echo (number_format(floatval($reservation_data['totalBeforeDiscount']), 2, '.', '')); ?></span> €</p>
                    <?php } ?>
                </div>
            </div>
        </div>
